<template>
  <div class="card p-3 sm:p-6">
    <div class="mb-4 sm:mb-8">
      ...
      >
        <Icon name="GraduationCap" class="mr-2 text-blue-600 sm:mr-3" />
        Claude Code 使用教程
      </h3>
    ...
    <!-- 系统选择标签 -->
    <div class="mb-4 sm:mb-8">
      <div class="flex flex-wrap gap-1 rounded-md bg-gray-100 p-1 dark:bg-gray-800 sm:gap-2 sm:p-2">
        <button
          v-for="system in tutorialSystems"
          :key="system.key"
          :class="[
            'flex flex-1 items-center justify-center gap-1 rounded-md px-3 py-2 text-xs font-semibold transition-all duration-300 sm:gap-2 sm:px-6 sm:py-3 sm:text-sm',
    ...
    <div v-if="activeTutorialSystem === 'windows'" class="tutorial-content">
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-md bg-blue-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >1</span
          >
          安装 Node.js 环境
        </h4>
        ...
        <div
          class="mb-4 rounded-md border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 dark:border-blue-500/40 dark:from-blue-950/30 dark:to-indigo-950/30 sm:mb-4 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Square" class="mr-2 text-blue-600" />
            Windows 安装方法
          </h5>
          <div class="mb-3 sm:mb-4">
            ...
            >
              <li>
                打开浏览器访问
                <code
                  class="rounded-md bg-gray-100 px-1 py-1 text-xs dark:bg-gray-800 dark:text-yellow-400 sm:px-2 sm:text-sm"
          ...
          <div class="mb-3 sm:mb-4">
            ...
            <div
              class="overflow-x-auto rounded-md bg-gray-900 p-3 font-mono text-xs text-green-400 dark:border dark:border-slate-700 dark:bg-slate-900 sm:p-4 sm:text-sm"
            >
          ...
          <div
            class="rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-950/30 sm:p-4"
          >
        ...
        <!-- 验证安装 -->
        <div
          class="rounded-md border border-green-200 bg-green-50 p-3 dark:border-green-500/40 dark:bg-green-950/30 sm:p-4"
        >
          ...
          <div
            class="overflow-x-auto rounded-md bg-gray-900 p-2 font-mono text-xs text-green-400 sm:p-3 sm:text-sm"
          >
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-md bg-green-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >2</span
          >
          安装 Claude Code
        </h4>
        ...
        <div
          class="mb-4 rounded-md border border-green-100 bg-gradient-to-r from-green-50 to-emerald-50 p-4 dark:border-green-500/40 dark:from-green-950/30 dark:to-emerald-950/30 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Download" class="mr-2 text-green-600" />
            安装 Claude Code
          </h5>
          ...
          <div
            class="mb-4 overflow-x-auto rounded-md bg-gray-900 p-3 font-mono text-xs text-green-400 sm:p-4 sm:text-sm"
          >
          ...
          <div
            class="mt-4 rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-950/30 sm:p-4"
          >
            <h6 class="mb-2 text-sm font-medium text-blue-800 dark:text-blue-300 sm:text-base">
              提示
            </h6>
      ...
      <div class="mb-6 sm:mb-10">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-md bg-purple-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >3</span
          >
          设置环境变量
        </h4>
        ...
        <div
          class="mb-4 rounded-md border border-purple-100 bg-gradient-to-r from-purple-50 to-pink-50 p-4 dark:border-purple-500/40 dark:from-purple-950/30 dark:to-pink-950/30 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Settings" class="mr-2 text-purple-600" />
            配置 Claude Code 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          ...
          <div class="space-y-4">
            <div
              class="rounded-md border border-purple-200 bg-white p-3 dark:border-purple-700 dark:bg-gray-800 sm:p-4"
            >
            ...
            >
              ...
              <div
                class="mb-3 overflow-x-auto rounded-md bg-gray-900 p-2 font-mono text-xs text-green-400 sm:p-3 sm:text-sm"
              >
        ...
        <!-- VSCode 插件配置 -->
        <div
          class="mt-6 rounded-md border border-indigo-200 bg-indigo-50 p-3 dark:border-indigo-500/40 dark:bg-indigo-950/30 sm:p-4"
        >
          ...
          <div class="mb-3 space-y-2">
            <p class="text-sm text-indigo-700 dark:text-indigo-300">
              ...
              <code class="rounded-md bg-indigo-100 px-1 dark:bg-indigo-900"
        ...
        <!-- 验证环境变量设置 -->
        <div
          class="mt-6 rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-950/30 sm:p-4"
        >
          ...
          <div class="space-y-4">
            <div>
              ...
              <div
                class="space-y-1 overflow-x-auto rounded-md bg-gray-900 p-2 font-mono text-xs text-green-400 sm:p-3 sm:text-sm"
              >
          ...
          <div class="mt-3 space-y-2">
            ...
            <div class="rounded-md bg-gray-100 p-2 font-mono text-sm dark:bg-gray-700">
        ...
        <div class="mt-8">
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Bot" class="mr-2 text-green-600" />
            配置 Gemini CLI 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          ...
          <div class="space-y-4">
            <div
              class="rounded-md border border-green-200 bg-white p-3 dark:border-green-700 dark:bg-gray-800 sm:p-4"
            >
              <h6 class="mb-2 text-sm font-medium text-gray-800 dark:text-gray-300 sm:text-base">
                PowerShell 设置方法
              </h6>
        ...
        <div class="mt-8">
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Code" class="mr-2 text-indigo-600" />
            配置 Codex 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          ...
          <div class="space-y-4">
            <div
              class="rounded-md border border-yellow-200 bg-yellow-50 p-3 dark:border-yellow-500/40 dark:bg-yellow-950/30 sm:p-4"
            >
              ...
              <p class="mb-3 text-sm text-yellow-700 dark:text-yellow-300">
                在
                <code class="rounded-md bg-yellow-100 px-1 dark:bg-yellow-900"
              ...
              <div
                class="mt-2 overflow-x-auto rounded-md bg-gray-900 p-2 font-mono text-xs text-green-400 sm:p-3 sm:text-sm"
              >
                <div
      ...
      <div class="mt-8">
        <h5
          class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
        >
          <Icon name="Terminal" class="mr-2 text-blue-600" />
          配置 Droid CLI
        </h5>
        <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          Droid CLI 使用
          <code class="rounded-md bg-gray-100 px-1 dark:bg-gray-800">~/.factory/config.json</code>
          保存自定义模型；在 Windows 中可直接编辑
          <code class="rounded-md bg-gray-100 px-1 dark:bg-gray-800"
      ...
      <div class="mb-6 sm:mb-8">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-md bg-orange-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >4</span
          >
          开始使用 Claude Code
        </h4>
        <div
          class="rounded-md border border-orange-100 bg-gradient-to-r from-orange-50 to-yellow-50 p-4 dark:border-orange-500/40 dark:from-orange-950/30 dark:to-yellow-950/30 sm:p-6"
        >
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
      ...
      <div class="mb-8">
        <h4
          class="mb-3 flex items-center text-lg font-semibold text-gray-800 dark:text-gray-300 sm:mb-4 sm:text-xl"
        >
          <Icon name="Wrench" class="mr-2 text-red-600 sm:mr-3" />
          Windows 常见问题解决
        </h4>
        <div class="space-y-4">
          <details
              ...
              <ul class="list-inside list-disc space-y-1 text-sm">
                ...
                <li>
                  或者配置 npm 使用用户目录：<code
                    class="rounded-md bg-gray-200 px-1 text-xs dark:bg-gray-700 sm:text-sm"
    ...
    <div v-else-if="activeTutorialSystem === 'macos'" class="tutorial-content">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div
          class="mb-4 rounded-md border border-gray-200 bg-gradient-to-r from-gray-50 to-slate-50 p-4 dark:border-gray-700 dark:from-gray-800 dark:to-slate-800 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Apple" class="mr-2 text-gray-700 dark:text-gray-400" />
            macOS 安装方法
          </h5>
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            >
              <li>
                访问
                <code
                  class="rounded-md bg-gray-100 px-1 py-1 text-xs dark:bg-gray-700 sm:px-2 sm:text-sm"
                  >https://nodejs.org/</code
                >
              </li>
          ...
          <div
            class="rounded-md border border-gray-200 bg-gray-50 p-3 dark:border-gray-600 dark:bg-gray-800 sm:p-4"
          >
            <h6 class="mb-2 text-sm font-medium text-gray-800 dark:text-gray-300 sm:text-base">
              macOS 注意事项
            </h6>
            <ul class="space-y-1 text-xs text-gray-700 dark:text-gray-300 sm:text-sm">
              <li>
                • 如果遇到权限问题，可能需要使用
                <code class="rounded-md bg-gray-200 px-1 text-xs dark:bg-gray-700 sm:text-sm"
                  >sudo</code
                >
              </li>
      ...
      <div class="mb-6 sm:mb-10">
        ...
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Download" class="mr-2 text-purple-600" />
            安装 Claude Code
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
            打开 Terminal，运行以下命令：
          ...
          <div
            class="overflow-x-auto rounded-md bg-gray-900 p-3 font-mono text-xs text-green-400 sm:p-4 sm:text-sm"
          >
            <div class="whitespace-nowrap text-gray-300">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div
          class="mb-4 rounded-md border border-orange-100 bg-gradient-to-r from-orange-50 to-yellow-50 p-4 dark:border-orange-500/40 dark:from-orange-950/30 dark:to-yellow-950/30 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Settings" class="mr-2 text-orange-600" />
            配置 Claude Code 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
            为了让 Claude Code 连接到你的中转服务，需要设置两个环境变量：
          ...
          <div class="space-y-4">
            <div
              class="rounded-md border border-orange-200 bg-white p-3 dark:border-orange-700 dark:bg-gray-800 sm:p-4"
            >
              <h6 class="mb-2 text-sm font-medium text-gray-800 dark:text-gray-300 sm:text-base">
                方法一：临时设置（当前会话）
              </h6>
      ...
      <div class="mt-8">
        ...
        <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          ...
          <code class="rounded-md bg-gray-100 px-1 dark:bg-gray-800">⌘ + Shift + G</code>
          并输入路径，或运行
          <code class="rounded-md bg-gray-100 px-1 dark:bg-gray-800">open ~/.factory</code>
          快速打开配置目录。
        </p>
        <div
          class="rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-950/30 sm:p-4"
      ...
      <div class="mb-8">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-md bg-yellow-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >4</span
          >
          开始使用 Claude Code
        </h4>
        <div
          class="rounded-md border border-yellow-100 bg-gradient-to-r from-yellow-50 to-amber-50 p-4 dark:border-yellow-500/40 dark:from-yellow-950/30 dark:to-amber-950/30 sm:p-6"
        >
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
            现在你可以开始使用 Claude Code 了！
          </p>
    ...
    <div v-else-if="activeTutorialSystem === 'linux'" class="tutorial-content">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div
          class="mb-4 rounded-md border border-orange-100 bg-gradient-to-r from-orange-50 to-red-50 p-4 dark:border-orange-500/40 dark:from-orange-950/30 dark:to-red-950/30 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <Icon name="Circle" class="mr-2 text-orange-600" />
            Linux 安装方法
          </h5>
          <div class="mb-4">
          ...
          <div
            class="rounded-md border border-orange-200 bg-orange-50 p-3 dark:border-orange-500/40 dark:bg-orange-950/30 sm:p-4"
          >
            ...
            <ul class="space-y-1 text-xs text-orange-700 dark:text-orange-300 sm:text-sm">
              ...
              <li>
                • 如果遇到权限问题，使用
                <code class="rounded-md bg-orange-200 px-1 dark:bg-orange-900">sudo</code>
              </li>
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div class="mt-8">
          ...
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
            ...
            >
            或在终端运行
            <code class="rounded-md bg-gray-100 px-1 dark:bg-gray-800">xdg-open ~/.factory</code>
            打开目录。
          </p>
          <div
            class="rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-950/30 sm:p-4"
      ...
      <!-- 结尾 -->
      <div
        class="rounded-md bg-gradient-to-r from-blue-500 to-purple-600 p-4 text-center text-white sm:p-6"
      >
...
/* 行内代码样式优化 */
html.dark :deep(code.rounded-md) {
