<template>
  <PageContainer max-width="7xl" :show-footer="false" :transparent="transparent">
    <template #header>
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-1 text-[10px] text-gray-600 dark:text-gray-400">
            跟着这个教程，你可以轻松配置 Claude Code、Gemini CLI、Codex、Droid CLI 等多种 AI 工具
          </p>
        </div>
    ...
    <!-- 系统选择标签 -->
    <Card v-if="!transparent" class="rounded-b-none border-b-0" :no-padding="true">
      <div class="px-6">
        <nav
          aria-label="System Tabs"
          class="flex gap-8 border-b border-gray-200 dark:border-gray-700"
        >
          <button
            v-for="option in systemOptions"
            :key="option.value"
            class="relative border-b-2 px-1 pb-2 pt-3 text-sm font-medium transition-colors"
            :class="
    ...
    <div v-else>
      <div>
        <nav aria-label="System Tabs" class="flex gap-8">
          <button
            v-for="option in systemOptions"
            :key="option.value"
            class="relative border-b-2 px-1 pb-2 pt-3 text-sm font-medium transition-colors"
    ...
    <!-- Windows 教程 -->
    <Card
      v-if="activeTutorialSystem === 'windows' && !transparent"
    ...
    >
      <div class="space-y-6">
        ...
        <div class="mt-8">
          <h4
            class="relative mb-4 border-b-2 border-gray-100 pb-3 text-xl font-semibold text-gray-800 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-24 after:bg-primary-500 after:content-[''] dark:border-gray-700 dark:text-white"
          >
            <span
              class="mr-2 inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-500 font-bold text-white shadow-md"
            >
          ...
          <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">
            除了 Claude Code，本服务还支持以下 AI 工具。根据你的需求选择配置：
          </p>

          <div class="grid gap-6 md:grid-cols-1">
            <!-- Gemini CLI -->
            <div
              class="group overflow-hidden rounded-xl border-2 border-primary-200 bg-gradient-to-br from-primary-50 to-primary-50 shadow-sm transition-all hover:shadow-lg dark:border-primary-800 dark:from-primary-950/30 dark:to-primary-950/30"
            >
              <div
                class="border-b-2 border-primary-200 bg-primary-100/80 px-5 py-4 dark:border-primary-800 dark:bg-primary-900/40"
              >
                <div class="flex items-center gap-3">
                  <div
                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 to-primary-500 shadow-md"
                  >
                    <Zap class="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <h5 class="text-lg font-bold text-primary-700 dark:text-primary-400">
                      Gemini CLI
                    </h5>
            ...
            >
              ...
              >
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <h5 class="text-lg font-bold text-primary-700 dark:text-primary-400">Codex</h5>
                    <p class="text-xs text-primary-600 dark:text-primary-500">
                      OpenAI Responses 格式工具
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div v-else-if="activeTutorialSystem === 'windows' && transparent">
      <div class="space-y-6">
        <!-- 第一步：安装 Node.js -->
        <div>
          <h4
    ...
    <!-- macOS 教程 -->
    <Card v-if="activeTutorialSystem === 'macos' && !transparent" class="rounded-t-none border-t-0">
      <div class="space-y-6">
        <!-- 第一步：安装 Node.js -->
        <div>
          <h4
            ...
            >
              ...
              <div class="p-5">
                ...
                <div>
                  ...
                  <p class="mb-3 text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                    将以下���容追加到配置文件中，并替换示例中的域名和 API 密钥：
                  </p>
                  <CodeBlock language="json" :lines="droidCliConfigLines" />
                  <p class="mb-3 text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                    💡 在 Droid CLI 中选择自定义模型即可使用新的 Droid
    ...
    <div v-else-if="activeTutorialSystem === 'macos' && transparent">
      <div class="space-y-6">
        <!-- 第一步：安装 Node.js -->
        <div>
          <h4
    ...
    <!-- Linux 教程 -->
    <Card v-if="activeTutorialSystem === 'linux' && !transparent" class="rounded-t-none border-t-0">
      <div class="space-y-6">
        <!-- 第一步：安装 Node.js -->
        <div>
          <h4
    ...
    <div v-else-if="activeTutorialSystem === 'linux' && transparent">
      <div class="space-y-6">
        <!-- 第一步：安装 Node.js -->
        <div>
          <h4
...
import { Card } from '@/ui'
import { ChevronRight, Layers, Zap, Code, Monitor } from 'lucide-vue-next'
