  ...
  <div>
    ...
    <div>
      <div>
        ...
        <p>Manage users, their API keys, and view usage statistics</p>
      </div>
      <div>
        ...
        <div>
          <div>
            ...
            <div>
              <dl>
                <dt>Total Cost</dt>
                <dd>${{ (userStats?.totalUsage?.totalCost || 0).toFixed(4) }}</dd>
              </dl>
            </div>
          </div>
        </div>
    ...
    <div>
      <div>
        <h3>
          Users
          <span v-if="!loading">({{ filteredUsers.length }} of {{ users.length }})</span>
        </h3>
      </div>
      ...
      <!-- Users List -->
      <ul v-else-if="filteredUsers.length > 0" role="list">
        <li v-for="user in filteredUsers" :key="user.id">
          <div>
            ...
            <div>
              <!-- View Usage Stats -->
              <button title="View Usage Stats" @click="viewUserStats(user)">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
              ...
              <!-- Change Role -->
              <button title="Change Role" @click="changeUserRole(user)">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
...
const toggleUserStatus = (user) => {
  ...
  confirmAction.value = {
    ...
    confirmClass: user.isActive ? ' hover:' : ' hover:',
    action: 'toggleStatus'
  }
