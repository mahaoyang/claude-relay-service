<template>
  <Teleport to="body">
    ...
    >
      ...
      <div
        class="relative z-10 mx-3 flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-md border border-gray-200/70 bg-white/95 shadow-2xl ring-1 ring-black/5 transition-all dark:border-gray-700/60 dark:bg-gray-900/95 dark:ring-white/10 sm:mx-4 sm:p-1"
      >
        <!-- 顶部栏 -->
        <div
        ...
        >
          <div class="flex flex-1 items-start gap-3">
            <div
              class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-blue-500 to-indigo-500 text-white shadow-lg"
            >
              <Icon name="AreaChart" class="text-lg" />
            </div>
            <div class="space-y-1">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <span
                  ...
                  class="inline-flex items-center rounded-md bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-700 dark:bg-blue-500/10 dark:text-blue-300"
                >
                  <Icon name="Layers" class="mr-1" />{{ platformLabel }}
                </span>
                <span
                  v-if="account?.accountType"
                  class="inline-flex items-center rounded-md bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-700 dark:bg-purple-500/10 dark:text-purple-300"
                >
                  <Icon name="UserCog" class="mr-1" />{{ accountTypeLabel }}
                </span>
              </div>
          ...
          <button
            class="flex h-10 w-10 items-center justify-center rounded-md bg-gray-100 text-gray-500 transition hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
            @click="handleClose"
          >
            <Icon name="X" />
          </button>
          ...
          <template v-else>
            ...
            <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <div
                ...
                :key="metric.key"
                class="rounded-md border border-gray-100 bg-white/80 p-4 shadow-sm transition dark:border-gray-700 dark:bg-gray-900/70"
              >
                <div class="flex items-start justify-between">
                  ...
                  <div
                    class="flex h-10 w-10 items-center justify-center rounded-md bg-gray-50 dark:bg-gray-800"
                  >
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
              <div
                class="space-y-3 rounded-md border border-blue-100 bg-blue-50/60 p-4 dark:border-blue-500/20 dark:bg-blue-900/20"
              >
                <div
                ...
                <div
                  class="rounded-md bg-white/80 p-3 text-sm text-gray-600 shadow-sm ring-1 ring-blue-100 dark:bg-gray-900/80 dark:text-gray-300 dark:ring-blue-500/20"
                >
              ...
              <div
                class="space-y-3 rounded-md border border-amber-100 bg-amber-50/70 p-4 dark:border-amber-500/20 dark:bg-amber-900/20"
              >
                <div
                ...
                <div
                  class="rounded-md bg-white/80 p-3 text-sm text-gray-600 shadow-sm ring-1 ring-amber-100 dark:bg-gray-900/80 dark:text-gray-300 dark:ring-amber-500/20"
                >
                  <div class="flex items-center justify-between">
                    <span>日期</span>
                    <span class="font-semibold text-gray-900 dark:text-gray-100">{{
              ...
              <div
                class="space-y-3 rounded-md border border-emerald-100 bg-emerald-50/60 p-4 dark:border-emerald-500/20 dark:bg-emerald-900/20"
              >
                <div
                ...
                <div
                  class="rounded-md bg-white/80 p-3 text-sm text-gray-600 shadow-sm ring-1 ring-emerald-100 dark:bg-gray-900/80 dark:text-gray-300 dark:ring-emerald-500/20"
                >
                  <div class="flex items-center justify-between">
                    <span>日期</span>
                    <span class="font-semibold text-gray-900 dark:text-gray-100">{{
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
              <div
                class="rounded-md border border-gray-100 bg-white/80 p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/70"
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <Icon name="Database" class="mr-2 text-indigo-500" /> 累计 Token
                </h4>
              ...
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <Icon name="Gauge" class="mr-2 text-purple-500" /> 平均速率
                </h4>
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <div class="flex items-center justify-between">
                    <span>RPM</span>
              ...
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <Icon name="Layers" class="mr-2 text-teal-500" /> 最近统计
                </h4>
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <div class="flex items-center justify-between">
                    <span>今日请求</span>
            ...
            <!-- 折线图 -->
            <div
              class="mb-6 rounded-md border border-gray-100 bg-white/80 p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900/70"
            >
              <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
                <h4
                  class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <Icon name="LineChart" class="mr-2 text-blue-500" /> 30天费用与请求趋势
                </h4>
