<template>
  <div class="space-y-6">
    ...
    <!-- Daily Usage Chart -->
    <div v-if="!loading && usageStats" class="rounded-md bg-white shadow">
      ...
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <div class="h-2 w-2 rounded-md bg-blue-500"></div>
              </div>
              <div class="ml-3">
    ...
    <div v-if="!loading && userApiKeys.length > 0" class="rounded-md bg-white shadow">
      <div class="px-4 py-5 sm:p-6">
